...
rule DESeq2_TEcount:
    ...
    output:
        ...
        contrast_gene_te_name = outdir + "/{contrast}/{contrast}.TEcount_Gene_TE.name.tsv",
        contrast_gene = outdir + "/{contrast}/{contrast}.TEcount_Gene.tsv",
        contrast_te = outdir + "/{contrast}/{contrast}.TEcount_TE.tsv",
        contrast_gene_te = outdir + "/{contrast}/{contrast}.TEcount_Gene_TE.tsv",
    params:
