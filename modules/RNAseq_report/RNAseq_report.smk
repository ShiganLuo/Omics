...
rule generate_report:
    input:
        ...
        contrast_pca = expand(outdir + "/diff_expression/{contrast}/PCA/cpmPCA.png", contrast=contrasts),
        contrast_gene_volcano = expand(outdir + "/diff_expression/{contrast}/volcano/TEcount_Gene_volcano.png", contrast=contrasts),
        contrast_gene_heatmap = expand(outdir + "/diff_expression/{contrast}/heatmap/TEcount_Gene_updown.png", contrast=contrasts),
