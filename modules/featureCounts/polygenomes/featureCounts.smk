...
rule featureCounts_single_noMultiple:
    ...
    output:
        outfile = outdir + "/{genome}/all_single_featureCounts.tsv"
    log:
        logdir + "/{genome}/all/featureCounts/featureCounts_single_noMultiple.log"
    conda: 
        "../featureCounts.yaml"
    container:
...
rule featureCounts_paired_noMultiple:
    ...
    output:
        outfile = outdir + "/{genome}/all_paired_featureCounts.tsv",
    log:
        logdir + "/{genome}/all/featureCounts/featureCounts_paired_noMultiple.log"
    conda:
        "../featureCounts.yaml"
    container:
        sif("../featureCounts.yaml")
...
rule featureCounts_result:
    input:
        paired = outdir + "/{genome}/all_paired_featureCounts.tsv",
        single = outdir + "/{genome}/all_single_featureCounts.tsv"
    output:
        touch(outdir + "/{genome}/featureCounts.done")
