...
rule ft_predict_m6a:
    ...
    log:
        logdir + "/{genome}/{sample_id}/ft_predict_m6a.log"
    threads: 16
    conda:
        "../fibertools.yaml"
    container:
...
rule ft_add_nucleosomes:
    ...
    log:
        logdir + "/{genome}/{sample_id}/ft_add_nucleosomes.log"
    threads: 16
    conda:
        "../fibertools.yaml"
    container:
...
rule ft_fire:
    ...
    log:
        logdir + "/{genome}/{sample_id}/ft_fire.log"
    threads: 8
    conda:
        "../fibertools.yaml"
    container:
...
rule ft_extract:
    ...
    log:
        logdir + "/{genome}/{sample_id}/ft_extract.log"
    threads: 8
    conda:
        "../fibertools.yaml"
    container:
