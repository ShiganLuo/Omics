...
samtools_sort_config = {
    "indir": f"{outdir}/pbmm2",
    "outdir": f"{outdir}/samtools",
    "logdir": logdir,
    "Procedure": {
...
use rule bam_index from samtools_sort as PacVar_bam_index
...
if not skip_phase and not skip_snp and not skip_sv:
    hiphase_snp_config = {
        ...
        "logdir": logdir,
        "samples": samples,
        "bam_dir": f"{outdir}/samtools/sort",
